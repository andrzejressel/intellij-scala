...
class SbtProjectResolver extends ExternalSystemProjectResolver[SbtExecutionSettings] with ExternalSourceRootResolution {
  ...
  private def addAllModuleDependencies(
    ...
    val moduleToDependencies =
      if (!separateProdTestSources) {
        ...
        mapToModuleNodeToDependencies(projectToModule)
      }
  ...
  private def createModules(
    ...
    addAllModuleDependencies(projectToModuleMap, insertProjectTransitiveDependencies, separateProdTestSources)
